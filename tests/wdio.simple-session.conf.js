...
// Ultra-simple session test - just to verify BrowserStack App Automate connection
exports.config = {
  runner: 'local',
  specs: [
  ...
  capabilities: [{
    'bstack:options': {
      ...
      projectName: 'DIL-Simple-Test',
      buildName: 'Simple-Test-' + new Date().toISOString().split('T')[0],
      sessionName: 'Simple Session Test',
