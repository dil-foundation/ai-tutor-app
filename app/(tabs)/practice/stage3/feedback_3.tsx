...
const FeedbackScreen3 = () => {
  ...
  const totalScenarios = parseInt(params.totalScenarios as string) || 5;
  ...
  const getScoreDescription = (score: number) => {
    if (score >= 80) return 'Excellent problem-solving skills! You\'ve mastered this scenario.';
    if (score >= 35) return 'Well done! Keep practicing to improve your problem-solving approach.';
  ...
  const handleNext = () => {
    if (currentScenarioId < totalScenarios) {
      // Navigate back to problem-solving screen with next scenario info
      router.push({
        pathname: '/(tabs)/practice/stage3/problem-solving' as any,
        params: {
          nextScenario: 'true',
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            <View style={styles.titleContainer}>
              ...
              <Text style={styles.headerSubtitle}>Problem-Solving Feedback</Text>
            ...
            >
              ...
              <View style={styles.metricsSection}>
                ...
                <View style={styles.metricsGrid}>
                  ...
                  {/* Problem-Solving Specific Metrics */}
                  {evaluationResult.response_type && (
                    <View style={styles.metricCard}>
                      <Ionicons name="construct" size={24} color="#58D68D" />
                      <Text style={styles.metricValue}>
                        {evaluationResult.response_type}
                      </Text>
              ...
              {/* Problem Description */}
              {evaluationResult.problem_description && (
                <View style={styles.problemSection}>
                  <Text style={styles.sectionTitle}>Problem Context</Text>
                  <View style={styles.problemCard}>
                    <Ionicons name="alert-circle" size={20} color="#58D68D" style={styles.problemIcon} />
                    <View style={styles.problemContent}>
                      <Text style={styles.problemTitle}>Problem Description</Text>
                      <Text style={styles.problemText}>{evaluationResult.problem_description}</Text>
                    </View>
                  </View>
                </View>
              )}
