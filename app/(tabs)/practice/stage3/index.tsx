  ...
  const activities = [
    {
      ...
      description: 'Tell stories and share experiences with fluent narrative',
    ...
    },
    {
      ...
      description: 'Participate in group conversations and discussions',
    ...
    },
    {
      ...
      description: 'Discuss problems and propose solutions confidently',
          ...
          <View style={styles.goalCard}>
            <View style={styles.goalContent}>
              ...
              <Text style={styles.goalDescription}>
                Express yourself fluently in conversations, tell stories, and discuss complex topics
              </Text>
            </View>
          </View>
        </Animated.View>
