...
const FeedbackScreen = () => {
  ...
  const totalPrompts = parseInt(params.totalPrompts as string) || 10;
  ...
  const getScoreDescription = (score: number) => {
    if (score >= 80) return 'Great storytelling! You\'ve mastered this prompt.';
  ...
  const handleNext = () => {
    if (currentPromptId < totalPrompts) {
      // Navigate back to storytelling screen with next prompt info
      router.push({
        pathname: '/(tabs)/practice/stage3/storytelling',
        params: {
          nextPrompt: 'true',
        ...
        <View style={styles.container}>
           ...
           <View style={styles.header}>
             <View style={styles.titleContainer}>
              ...
              <Text style={styles.headerSubtitle}>Storytelling Feedback</Text>
          ...
          <View style={styles.actionButtons}>
            ...
            {/* Show Next Story button when completed */}
            {isCompleted && (
              <TouchableOpacity
              ...
              >
                ...
                >
                  ...
                  <Text style={styles.nextButtonText}>
                    {currentPromptId < totalPrompts ? 'Next Story' : 'Finish'}
                  </Text>
                </LinearGradient>
              </TouchableOpacity>
            )}
