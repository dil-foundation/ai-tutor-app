...
const Stage6Screen = () => {
  ...
  const activities = [
    ...
    },
    {
      ...
      description: 'Simulate challenging scenarios to improve emotional intelligence and communication',
    ...
    },
    {
      ...
      description: 'Develop and articulate complex opinions on various topics with evidence and logic',
  ...
  const fetchProgress = useCallback(async () => {
    ...
    setIsLoading(true);
    try {
      console.log('🔄 [STAGE 6] Fetching latest progress...');
      ...
      if (result.success && result.data) {
        ...
        if (stage6) {
          ...
          console.log('✅ [STAGE 6] Progress updated:', completed);
        }
      } else {
        console.error("❌ [STAGE 6] Failed to fetch progress:", result.message);
      }
    } catch (error) {
      console.error("❌ [STAGE 6] Error fetching progress:", error);
    } finally {
      setIsLoading(false);
    }
  }, [user]);
  ...
  if (isLoading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Loading Stage 6...</Text>
      </View>
    );
  }
          ...
          >
            <View style={styles.goalContent}>
              ...
              <Text style={styles.goalDescription}>
                Master real-time fluency, advanced argumentation, and nuanced emotional communication with excellence
              </Text>
            </View>
          </LinearGradient>
        </Animated.View>
