...
const FeedbackScreen = () => {
  ...
  const totalScenarios = parseInt(params.totalScenarios as string) || 10;
  ...
  const getScoreDescription = (score: number) => {
    if (score >= 80) return 'Great handling of the sensitive scenario! You\'ve mastered this exercise.';
    if (score >= 60) return 'Well done! Keep practicing to improve your diplomatic skills further.';
  ...
  const handleNext = () => {
    if (currentScenarioId < totalScenarios) {
      // Navigate back to sensitive scenario screen with next scenario info
      router.push({
        pathname: '/(tabs)/practice/stage6/roleplay-handle-sensitive-scenario',
        params: {
          nextScenario: 'true',
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            <View style={styles.titleContainer}>
              ...
              <Text style={styles.headerSubtitle}>Sensitive Scenario Feedback</Text>
          ...
          >
            ...
            >
              ...
              <View style={styles.metricsSection}>
                ...
                <View style={styles.metricsGrid}>
                  ...
                  <View style={styles.metricCard}>
                    ...
                    <Text style={styles.metricValue}>
                      {evaluationResult.evaluation?.tone_control_score || 0}/100
                    </Text>
                    <Text style={styles.metricLabel}>Tone Control</Text>
                  </View>
                  
                  <View style={styles.metricCard}>
                    <Ionicons name="heart" size={24} color="#58D68D" />
                    <Text style={styles.metricValue}>
                      {evaluationResult.evaluation?.empathy_authority_balance_score || 0}/100
                    </Text>
                    <Text style={styles.metricLabel}>Empathy Balance</Text>
                  </View>
                </View>
                ...
                <View style={styles.metricsGrid}>
                  <View style={styles.metricCard}>
                    ...
                    <Text style={styles.metricValue}>
                      {evaluationResult.evaluation?.clarity_communication_score || 0}/100
                    </Text>
                  ...
                  <View style={styles.metricCard}>
                    ...
                    <Text style={styles.metricValue}>
                      {evaluationResult.evaluation?.conflict_resolution_score || 0}/100
                    </Text>
              ...
              {evaluationResult.evaluation?.tone_analysis && (
                <View style={styles.analysisSection}>
                  <Text style={styles.sectionTitle}>Tone Analysis</Text>
                  <View style={styles.analysisCard}>
                    <Ionicons name="shield-checkmark" size={20} color="#58D68D" style={styles.analysisIcon} />
              ...
              {evaluationResult.evaluation?.empathy_authority_analysis && (
                <View style={styles.analysisSection}>
                  <Text style={styles.sectionTitle}>Empathy vs Authority Balance</Text>
                  <View style={styles.analysisCard}>
                    <Ionicons name="heart" size={20} color="#58D68D" style={styles.analysisIcon} />
                    <Text style={styles.analysisText}>
                      {evaluationResult.evaluation.empathy_authority_analysis}
                    </Text>
                  </View>
              ...
              {evaluationResult.evaluation?.clarity_analysis && (
                <View style={styles.analysisSection}>
                  <Text style={styles.sectionTitle}>Communication Clarity</Text>
                  <View style={styles.analysisCard}>
                    <Ionicons name="chatbubbles" size={20} color="#58D68D" style={styles.analysisIcon} />
                    <Text style={styles.analysisText}>
                      {evaluationResult.evaluation.clarity_analysis}
                    </Text>
                  </View>
              ...
              {evaluationResult.evaluation?.conflict_resolution_analysis && (
                <View style={styles.analysisSection}>
                  <Text style={styles.sectionTitle}>Conflict Resolution</Text>
                  <View style={styles.analysisCard}>
                    <Ionicons name="people" size={20} color="#58D68D" style={styles.analysisIcon} />
                    <Text style={styles.analysisText}>
                      {evaluationResult.evaluation.conflict_resolution_analysis}
                    </Text>
                  </View>
