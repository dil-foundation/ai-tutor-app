...
const Stage5Screen = () => {
  ...
  const activities = [
    {
      ...
      description: 'Engage in thought-provoking conversations on complex topics with depth',
    ...
    },
    {
      ...
      description: 'Practice delivering polished presentations on academic subjects with confidence',
  ...
  const fetchProgress = useCallback(async () => {
    ...
    setIsLoading(true);
    try {
      console.log('🔄 [STAGE 5] Fetching latest progress...');
      const result = await ProgressHelpers.forceRefreshProgress();
      if (result.success && result.data) {
        const stage5 = result.data.stages.find((stage: any) => stage.stage_id === 5);
        if (stage5 && stage5.exercises) {
          const completed: number[] = [];
          stage5.exercises.forEach((exercise: any, index: number) => {
          ...
          console.log('✅ [STAGE 5] Progress updated:', completed);
        }
      } else {
        console.error("❌ [STAGE 5] Failed to fetch progress:", result.message);
      }
    } catch (error) {
      console.error("❌ [STAGE 5] Error fetching progress:", error);
    } finally {
      setIsLoading(false);
    }
  }, [user]);
  ...
  if (isLoading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Loading Stage 5...</Text>
      </View>
    );
  }
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.titleContainer}>
              ...
              <Text style={styles.headerSubtitle}>C1 Advanced Level</Text>
            </View>
          </View>
        </Animated.View>
          ...
          >
            <View style={styles.goalContent}>
              ...
              <Text style={styles.goalDescription}>
                Understand and produce complex texts, and express ideas fluently and spontaneously with mastery
              </Text>
            </View>
          </LinearGradient>
        </Animated.View>
