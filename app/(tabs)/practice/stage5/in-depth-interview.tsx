...
const InDepthInterviewScreen = () => {
  ...
  const [totalPrompts, setTotalPrompts] = useState(7);
    ...
    try {
      ...
      const response = await authenticatedFetch(API_ENDPOINTS.EVALUATE_IN_DEPTH_INTERVIEW, {
        ...
        body: JSON.stringify({
          ...
          filename: `in_depth_interview_${currentPrompt.id}_${Date.now()}.m4a`,
          user_id: user.id,
      ...
      if (result.success) {
        ...
        router.push({
          pathname: '/(tabs)/practice/stage5/feedback_9' as any,
          params: {
  ...
  const moveToNextPrompt = () => {
    if (currentPromptId < totalPrompts) {
      ...
      Alert.alert(
        'Congratulations! 🎉',
        'You\'ve completed all in-depth interview questions!',
          ...
          >
            ...
            <View style={styles.titleContainer}>
              ...
              <Text style={styles.questionCounter}>
                Question: {currentPromptId} of {totalPrompts}
              </Text>
            </View>
          </Animated.View>
              ...
              {isExerciseCompleted ? (
                <View style={styles.completedContainer}>
                  ...
                  <Text style={styles.completedText}>
                    Congratulations! You have successfully completed all In-Depth Interview exercises.
                  </Text>
                  ...
                  <View style={styles.promptContainer}>
                    ...
                    <View style={styles.metaContainer}>
                      <View style={styles.metaChip}>
                        <Text style={styles.metaText}>{currentPrompt.category}</Text>
                      </View>
                      <View style={styles.metaChip}>
                        <Text style={styles.metaText}>{currentPrompt.difficulty}</Text>
                      </View>
                    </View>
                    ...
                    <View style={styles.structureContainer}>
                      ...
                      <Text style={styles.structureText}>{currentPrompt.expected_structure}</Text>
                    </View>
                    ...
                    <View style={styles.keywordsContainer}>
                      ...
                      <View style={styles.keywordsList}>
                        {currentPrompt.expected_keywords.map((keyword, index) => (
                    ...
                    <View style={styles.vocabularyContainer}>
                      ...
                      <View style={styles.vocabularyList}>
                        {currentPrompt.vocabulary_focus.map((word, index) => (
                    ...
                    <Text style={styles.instructionText}>
                      Listen to the question and provide a professional interview response using the STAR method
                    </Text>
                  </View>
                </ScrollView>
              ) : (
