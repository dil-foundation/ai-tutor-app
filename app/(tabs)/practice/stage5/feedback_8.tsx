...
const FeedbackScreen = () => {
  ...
  const totalTopics = parseInt(params.totalTopics as string) || 7;
  ...
  const getScoreDescription = (score: number) => {
    if (score >= 80) return 'Outstanding presentation! You\'ve mastered this academic topic.';
  ...
  const handleNext = () => {
    if (currentTopicId < totalTopics) {
      // Navigate back to academic presentation screen with next topic info
      router.push({
        pathname: '/(tabs)/practice/stage5/academic-presentation',
        params: {
          nextTopic: 'true',
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            <View style={styles.titleContainer}>
              ...
              <Text style={styles.headerSubtitle}>Academic Presentation Feedback</Text>
          ...
          >
            ...
            >
              ...
              <View style={styles.metricsSection}>
                ...
                {/* Academic Presentation Specific Metrics */}
                <View style={styles.metricsGrid}>
                  <View style={styles.metricCard}>
                    <Ionicons name="analytics" size={24} color="#45B7A8" />
                    <Text style={styles.metricValue}>
                      {evaluationResult.argument_structure_score || 0}/100
                    </Text>
                    <Text style={styles.metricLabel}>Structure</Text>
                  </View>
                  
                  <View style={styles.metricCard}>
                    <Ionicons name="business" size={24} color="#45B7A8" />
                    <Text style={styles.metricValue}>
                      {evaluationResult.academic_tone_score || 0}/100
                    </Text>
                    <Text style={styles.metricLabel}>Academic Tone</Text>
                  </View>
                </View>
              </View>
