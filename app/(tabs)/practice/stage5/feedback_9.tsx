...
const Feedback9Screen = () => {
  ...
  const currentPromptId = parseInt(params.currentPromptId as string) || 1;
  const totalPrompts = parseInt(params.totalPrompts as string) || 7;
  ...
  const getScoreDescription = (score: number) => {
    if (score >= 80) return 'Outstanding interview response! You\'ve mastered this question.';
  ...
  const handleNext = () => {
    if (currentPromptId < totalPrompts) {
      // Navigate back to in-depth interview screen with next prompt info
      router.push({
        pathname: '/(tabs)/practice/stage5/in-depth-interview',
        params: {
          nextPrompt: 'true',
          currentPromptId: (currentPromptId + 1).toString(),
        }
      });
    } else {
      // Exercise completed, go back to stage 5 index
      router.push('/(tabs)/practice/stage5');
    }
  };
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            <View style={styles.titleContainer}>
              ...
              <Text style={styles.headerSubtitle}>In-Depth Interview Feedback</Text>
              ...
              >
                ...
                >
                  ...
                  <Text style={styles.nextButtonText}>
                    {currentPromptId < totalPrompts ? 'Next Question' : 'Finish'}
                  </Text>
                </LinearGradient>
              </TouchableOpacity>
            )}
...
export default Feedback9Screen; 