...
const FeedbackScreen = () => {
  ...
  const currentQuestionId = parseInt(params.currentQuestionId as string) || 1;
  const totalQuestions = parseInt(params.totalQuestions as string) || 8;
  ...
  const handleNext = () => {
    if (currentQuestionId < totalQuestions) {
      // Navigate back to mock interview screen with next question info
      router.push({
        pathname: '/(tabs)/practice/stage4/mock-interview',
        params: {
          nextQuestion: 'true',
          currentQuestionId: (currentQuestionId + 1).toString(),
        }
      });
    } else {
      // Exercise completed, go back to stage 4 index
      router.push('/(tabs)/practice/stage4');
    }
  };
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            <View style={styles.titleContainer}>
              ...
              <Text style={styles.headerSubtitle}>Mock Interview Feedback</Text>
            ...
            >
              ...
              <View style={styles.scoreSection}>
                ...
                <View style={styles.scoreCircle}>
                  <LinearGradient
                    colors={[getScoreColor(evaluationResult.evaluation?.overall_score || 0), getScoreColor(evaluationResult.evaluation?.overall_score || 0) + '80']}
                    style={styles.scoreGradient}
                  >
                    <Text style={styles.scoreValue}>
                      {evaluationResult.evaluation?.overall_score || 0}
                    </Text>
                    <Text style={styles.scoreMax}>/100</Text>
                  </LinearGradient>
                </View>
                <Text style={styles.scoreMessage}>
                  {getScoreMessage(evaluationResult.evaluation?.overall_score || 0)}
                </Text>
                <Text style={styles.scoreDescription}>
                  {getScoreDescription(evaluationResult.evaluation?.overall_score || 0)}
                </Text>
                ...
                <View style={[styles.completionStatus, { backgroundColor: isCompleted ? '#D4EDDA' : '#FFF3CD' }]}>
                  ...
                  <Text style={[styles.completionStatusText, { color: isCompleted ? '#155724' : '#856404' }]}>
                    {isCompleted ? 'Question Completed! 🎉' : 'Keep Practicing 💪'}
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.metricsSection}>
                ...
                <View style={styles.interviewMetricsGrid}>
                  <View style={styles.metricCard}>
                    <Ionicons name="checkmark-circle" size={24} color="#4A90E2" />
                    <Text style={styles.metricValue}>
                      {evaluationResult.answer_relevance_score || 0}/25
                    </Text>
                  ...
                  <View style={styles.metricCard}>
                    ...
                    <Text style={styles.metricValue}>
                      {evaluationResult.confidence_tone_score || 0}/25
                    </Text>
                  ...
                  <View style={styles.metricCard}>
                    ...
                    <Text style={styles.metricValue}>
                      {evaluationResult.interview_vocabulary_score || 0}/25
                    </Text>
          ...
          <View style={styles.actionButtons}>
            ...
            {/* Show Next Question button when completed */}
            {isCompleted && (
              <TouchableOpacity
              ...
              >
                ...
                >
                  ...
                  <Text style={styles.nextButtonText}>
                    {currentQuestionId < totalQuestions ? 'Next Question' : 'Finish'}
                  </Text>
                </LinearGradient>
              </TouchableOpacity>
            )}
